...
### *Позитивные сценарии:*
:octocat: **1.** Оплата по дебетовой карте со статусом APPROVED:
...
:octocat: **2.** Оплата по дебетовой карте со статусом DECLINED:
...
:octocat: **3.** Оплата через кредит по данным карты со статусом APPROVED:
...
:octocat: **4.** Оплата через кредит по данным карты со статусом DECLINED:
...
:octocat: **1.** Оплата по карте, указан невалидный номер карты:
...
:octocat: **2.** Оплата по карте, указан невалидный месяц:
...
:octocat: **3.** Оплата по карте, указан год с истекшим сроком действия:
...
:octocat: **4.** Оплата по карте, указано некорректное имя:
...
:octocat: **5.** Оплата по карте, указано некорректное значение CVC/CVV:
...
:octocat: **6.** Оплата по карте, указаны пустые поля:
...
:octocat: **7.** Кредит по данным карты, указан невалидный номер карты:
...
:octocat: **8.** Кредит по данным карты, указан невалидный месяц:
...
:octocat: **9.** Кредит по данным карты, указан год с истекшим сроком действия:
...
:octocat: **10.** Кредит по данным карты, указано некорректное имя:
...
:octocat: **11.** Кредит по данным карты, указано некорректное значение CVC/CVV:
...
:octocat: **12.** Кредит по данным карты, указаны пустые поля:
...
- Планирование автоматизации тестирования: с 21.07.2021 до 22.07.2021
