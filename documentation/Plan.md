...
- написание автотестов, тестирование - 25-26 часов
- формирование и анализ отчетов - 8 часов

## *5. План сдачи работ:*

- Планировании автоматизации тестирования: 1-2 дня
- Непосредственно сама автоматизация: 7-10 дней
- Подготовка отчётных документов по итогам автоматизации: 2-3 дня
